...
const HeroSection = () => {
  return (
    <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 lg:pb-24 bg-gradient-to-b from-primary/5 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-primary/10 text-primary px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-10 leading-relaxed max-w-3xl mx-auto"
          >
          ...
          >
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-white px-6 py-4 sm:px-8 sm:py-6 text-base sm:text-lg" asChild>
              <a href="tel:+447375759686">
                <Phone className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                Call 07375 759686
              </a>
            </Button>
            <Button size="lg" variant="outline" className="px-6 py-4 sm:px-8 sm:py-6 text-base sm:text-lg" asChild>
              <Link href="/booking">
